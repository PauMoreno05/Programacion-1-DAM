...
//    int horas = Estructura_De_Datos.Utilidades.leerEntero("Introduce las horas trabajadas:");
//    double precio = Estructura_De_Datos.Utilidades.leerDoble("Introduce el precio por hora:");
//
